...
const Banner = () => {
    ...
    //TODO = 1ta matro chhobi niye kaj kora hoise, onnogulor kaj baki achhe; 
    ...
    <>
      <div className="carousel w-full my-24">
        <div id="slide1" className="carousel-item relative w-full rounded-xl">
          ...
          <div className="absolute flex top-0 bottom-0 gap-4 items-center bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)] rounded-xl">
            <div className="text-white space-y-7 pl-12 w-1/2">
              <h2 className="text-6xl font-bold">
                Affordable Price for Car Servicing
              </h2>
              <p className="">
                We have varieties of pricing options for different types of car
                servicing. Choose one that attracts you.
              </p>
              <div className="">
